...
Some scalable rendering parameters have to be updated at run-time to
provide optimal performance or influence other scalable rendering
...
resources for multi-view configurations, adapt the resolution to provide
a constant framerate or zoom images to allow monitoring of another view.
