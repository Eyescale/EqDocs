...
Version 1.8.RC1 for Equalizer 1.0$\beta$ \\[\medskipamount]
%  \today
}
...
\lstset{language=C++}
\section*{Equalizer 1.0$\beta$ Programming and User Guide}
\today
\subsection*{Contributors}

Written by Stefan Eilemann.\\ Contributions by Maxim Makhinya, Jonas B\"osch,
Christian Marten, Sarah Amsellem, Patrick Bouchaud, Philippe Robert, Robert
Hauck and Lucas Peetz Dulley.
...
right], 
\textsf{Bino}, a stereo-capable, multi-display video player\footnote{\link{http://bino.nongnu.org/}}
[middle center],
...
{\center\begin{tabularx}{\textwidth}{|l|l|X|}
    ...
    1.7.9   & Nov 03, 2010 & Add \sref{sErrorHandling}\\
    1.7.10  & Dec 21, 2010 & Review for Equalizer 1.0$\alpha$\\
    1.8.RC1  & Feb 22, 2010 & Review for Equalizer 1.0$\beta$\\
    \hline
  \end{tabularx}}
\clearpage
...
`GLUT on steroids', providing parallel and distributed execution, scalable
rendering features, an advanced network library and fully customizable event
handling.
...
Collage, the underlying network library, uses a peer-to-peer
structure. Equalizer utilizes this to provide optimal performance scalable
...
{\footnotesize\lstinputlisting[firstline=107, lastline=123]
  {../../../src/examples/eqHello/hello.cpp}}
...
\textsf{eq::server} namespace. The \textsf{eq::admin} namespace enables run-time
...
command line arguments are passed on to Equalizer. The are used to set certain
...
{\footnotesize\lstinputlisting[firstline=57, lastline=66]
  {../../../src/examples/eqPly/main.cpp}}
...
{\footnotesize\lstinputlisting[firstline=40, lastline=55]
  {../../../src/examples/eqPly/main.cpp}}
...
{\footnotesize\lstinputlisting[firstline=67, lastline=70]
  {../../../src/examples/eqPly/main.cpp}}

The third step is to create an instance of the application and to
initialize it locally. The application is a subclass of
\textsf{eq::Client}, which in turn is an \textsf{co::LocalNode}. The
underlying Collage network library, discussed in \sref{sNetwork}, is a
peer-to-peer network of \textsf{co::LocalNode}s. The client/server
...
\textsf{--eq-config}. If this configuration contains additional nodes, the
\textsf{server} and \textsf{appNode} sections need a globally reachable
\textsf{connection} configured for the render clients to connect to.

{\footnotesize\lstinputlisting[firstline=80, lastline=88]
  {../../../src/examples/eqPly/eqPly.cpp}}
...
making the static\_cast necessary:

{\footnotesize\lstinputlisting[firstline=90, lastline=100]
  {../../../src/examples/eqPly/eqPly.cpp}}
...
robustness attribute. This attribute is by default activated, allowing
configurations to launch even when some entities failed to initialize. If
activated, \textsf{Config::init} always returns true. If deactivated, it returns
...
{\footnotesize\lstinputlisting[firstline=101, lastline=118]
  {../../../src/examples/eqPly/eqPly.cpp}}
...
{\footnotesize\lstinputlisting[firstline=120, lastline=147]
  {../../../src/examples/eqPly/eqPly.cpp}}
...
{\footnotesize\lstinputlisting[firstline=148, lastline=152]
  {../../../src/examples/eqPly/eqPly.cpp}}
...
{\footnotesize\lstinputlisting[firstline=154, lastline=165]
  {../../../src/examples/eqPly/eqPly.cpp}}
...
{\footnotesize\lstinputlisting[firstline=167, lastline=175]
  {../../../src/examples/eqPly/eqPly.cpp}}
...
{\footnotesize\lstinputlisting[firstline=61, lastline=74]
  {../../../src/examples/eqPly/initData.cpp}}
...
\item The master instance of the object generates new versions for all
  slaves. These versions are continous, starting at
...
{\footnotesize\lstinputlisting[firstline=122, lastline=129]
  {../../../src/examples/eqPly/frameData.h}}
{\footnotesize\lstinputlisting[firstline=54, lastline=80]
  {../../../src/examples/eqPly/frameData.cpp}}
...
{\footnotesize\lstinputlisting[firstline=143, lastline=174]
  {../../../src/examples/eqPly/vertexBufferDist.cpp}}
...
{\footnotesize\lstinputlisting[firstline=74, lastline=95]
  {../../../src/examples/eqPly/config.cpp}}

After a successful initialization, the models are loaded and registered for data
distribution. When idle, Equalizer will pre-distribute object data during
...
{\footnotesize\lstinputlisting[firstline=97, lastline=99]
  {../../../src/examples/eqPly/config.cpp}}
...
{\footnotesize\lstinputlisting[firstline=100, lastline=118]
  {../../../src/examples/eqPly/config.cpp}}
...
{\footnotesize\lstinputlisting[firstline=130, lastline=139]
  {../../../src/examples/eqPly/config.cpp}}
...
{\footnotesize\lstinputlisting[firstline=310, lastline=317]
  {../../../src/examples/eqPly/config.cpp}}
...
{\footnotesize\lstinputlisting[firstline=319, lastline=327]
  {../../../src/examples/eqPly/config.cpp}}
...
{\footnotesize\lstinputlisting[firstline=329, lastline=359]
  {../../../src/examples/eqPly/config.cpp}}
...
{\footnotesize\lstinputlisting[firstline=387, lastline=390]
  {../../../src/examples/eqPly/config.cpp}}
{\footnotesize\lstinputlisting[firstline=450, lastline=481]
  {../../../src/examples/eqPly/config.cpp}}
{\footnotesize\lstinputlisting[firstline=528, lastline=534]
  {../../../src/examples/eqPly/config.cpp}}
...
The pre-process config instance maintains the mapped models, and lazily maps new
models, which are registered by the application process:

{\footnotesize\lstinputlisting[firstline=284, lastline=308]
  {../../../src/examples/eqPly/config.cpp}}
...
{\footnotesize\lstinputlisting[firstline=790, lastline=859]
  {../../../src/examples/eqPly/config.cpp}}
...
{\footnotesize\lstinputlisting[firstline=35, lastline=48]
  {../../../src/examples/eqPly/node.cpp}}
...
{\footnotesize\lstinputlisting[firstline=257, lastline=268]
  {../../../src/examples/eqPly/config.cpp}}
...
{\footnotesize\lstinputlisting[firstline=57, lastline=70]
  {../../../src/examples/eqPly/pipe.cpp}}
...
{\footnotesize\lstinputlisting[firstline=72, lastline=78]
  {../../../src/examples/eqPly/pipe.cpp}}
...
{\footnotesize\lstinputlisting[firstline=39, lastline=55]
  {../../../src/examples/eqPly/pipe.cpp}}
...
{\footnotesize\lstinputlisting[firstline=80, lastline=84]
  {../../../src/examples/eqPly/pipe.cpp}}
...
{\footnotesize\lstinputlisting[firstline=76, lastline=98]
  {../../../src/examples/eqPly/window.cpp}}
...
{\footnotesize\lstinputlisting[firstline=100, lastline=109]
  {../../../src/examples/eqPly/window.cpp}}
...
{\footnotesize\lstinputlisting[firstline=69, lastline=78]
  {../../../src/examples/eqPly/channel.cpp}}
...
{\footnotesize\lstinputlisting[firstline=123, lastline=137]
  {../../../src/examples/eqPly/channel.cpp}}
...
{\footnotesize\lstinputlisting[firstline=591, lastline=610]
  {../../../src/examples/eqPly/channel.cpp}}
...
{\footnotesize\lstinputlisting[firstline=619, lastline=689]
  {../../../src/examples/eqPly/channel.cpp}}
...
{\footnotesize\lstinputlisting[firstline=238, lastline=261]
  {../../../src/examples/eqPly/channel.cpp}}
...
{\footnotesize\lstinputlisting[firstline=36, lastline=57]
  {../../../src/examples/eqPixelBench/configEvent.h}}
...
{\footnotesize\lstinputlisting[firstline=58, lastline=71]
  {../../../src/examples/eqPixelBench/config.cpp}}
...
{\footnotesize\lstinputlisting[firstline=36, lastline=44]
  {../../../src/examples/eVolve/error.h}}

During initialization, eVolve may use these error codes:

{\footnotesize\lstinputlisting[firstline=45, lastline=57]
  {../../../src/examples/eVolve/window.cpp}}
...
{\footnotesize\lstinputlisting[firstline=37, lastline=73]
  {../../../src/examples/eVolve/error.cpp}}
...
{\footnotesize\lstinputlisting[firstline=124, lastline=140]
  {../../../src/libs/client/aglWindow.cpp}}
...
{\footnotesize\lstinputlisting[firstline=67, lastline=101]
  {../../../src/libs/client/glXWindow.cpp}}
...
{\footnotesize\lstinputlisting[firstline=178, lastline=224]
  {../../../src/libs/client/wglWindow.cpp}}
...
{\footnotesize\lstinputlisting[firstline=59, lastline=64, xleftmargin=-7em]
  {../../../src/examples/eqPly/view.h}}
{\footnotesize\lstinputlisting[firstline=58, lastline=76]
  {../../../src/examples/eqPly/view.cpp}}
...
might be applied to other multi-sampling effects, e.g., depth-of-field.
...
{\footnotesize\lstinputlisting[firstline=547, lastline=570]
  {../../../src/examples/eqPly/channel.cpp}}
...
will return the the computed jitter vector for the current frustum. This method
has a default implementation in \textsf{eq::Channel} for subpixel compounds, but
is overwritten in \textsf{eqPly} to perform idle anti-aliasing:

{\footnotesize\lstinputlisting[firstline=491, lastline=533]
  {../../../src/examples/eqPly/channel.cpp}}
...
{\footnotesize\lstinputlisting[firstline=305, lastline=337]
  {../../../src/examples/eqPly/channel.cpp}}
...
{\footnotesize\lstinputlisting[firstline=346, lastline=371]
  {../../../src/examples/eqPly/channel.cpp}}
...
compressed to 1\% of its original size since it contains a lot of black
background pixels. For readback the plugin with the name \textsf{0x101,
...
\item[Node/LocalNode] The abstraction of a process in the cluster. Nodes
  ...
  various connections and processes requests for a given process. A Node is a
...
An \textsf{co::ConnectionSet} is used to manage multiple connections. The
...
A remote \textsf{Node} can be either be connected explicitly be the application
or due to a connection from the given remote node. The explicit connection can
be done by programmatically creating a node, adding the necessary
...
slaves. If a specific order is needed, it is the application's responsibity to
...
{\footnotesize\lstinputlisting[firstline=87, lastline=98]
  {../../../website/documents/design/fileFormat.shtml}}
...
{\footnotesize\lstinputlisting[firstline=98, lastline=108]
  {../../../website/documents/design/fileFormat.shtml}}
{\footnotesize\lstinputlisting[firstline=172, lastline=172]
  {../../../website/documents/design/fileFormat.shtml}}
{\footnotesize\lstinputlisting[firstline=178, lastline=178]
  {../../../website/documents/design/fileFormat.shtml}}
{\footnotesize\lstinputlisting[firstline=205, lastline=205]
  {../../../website/documents/design/fileFormat.shtml}}
{\footnotesize\lstinputlisting[firstline=249, lastline=249]
  {../../../website/documents/design/fileFormat.shtml}}
...
{\footnotesize\lstinputlisting[firstline=107, lastline=125]
  {../../../website/documents/design/fileFormat.shtml}}
...
{\footnotesize\lstinputlisting[firstline=125, lastline=136]
  {../../../website/documents/design/fileFormat.shtml}}
...
{\footnotesize\lstinputlisting[firstline=136, lastline=158]
  {../../../website/documents/design/fileFormat.shtml}}
...
{\footnotesize\lstinputlisting[firstline=158, lastline=167]
  {../../../website/documents/design/fileFormat.shtml}}
...
{\footnotesize\lstinputlisting[firstline=172, lastline=176]
  {../../../website/documents/design/fileFormat.shtml}}
...
{\footnotesize\lstinputlisting[firstline=178, lastline=181]
  {../../../website/documents/design/fileFormat.shtml}}
...
{\footnotesize\lstinputlisting[firstline=181, lastline=202]
  {../../../website/documents/design/fileFormat.shtml}}
...
{\footnotesize\lstinputlisting[firstline=205, lastline=225]
  {../../../website/documents/design/fileFormat.shtml}}
...
{\footnotesize\lstinputlisting[firstline=225, lastline=246]
  {../../../website/documents/design/fileFormat.shtml}}
...
{\footnotesize\lstinputlisting[firstline=249, lastline=333]
  {../../../website/documents/design/fileFormat.shtml}}
