...
\date{
  ...
  Version 1.5.3 for Equalizer 0.6+svn\\[\medskipamount]
%  \today
}
...
\begin{wrapfigure}{r}{.618\textwidth}
  ...
  {\caption{\small\label{fExecutionFlow}Parallel Rendering}}\vspace{-2ex}
\end{wrapfigure}
...
\begin{wrapfigure}{r}{.618\textwidth}
  ...
  {\caption{\label{fPixel}\small A pixel compound}}\vspace{-5ex}
\end{wrapfigure}
...
\begin{wrapfigure}{r}{.618\textwidth}
  ...
  {\caption{\small\label{fFrusta}Wall and projection parameters}}
\end{wrapfigure}
...
this happens on each thread with windows, whereas on AGL it happens only
on the main thread. By default, Equalizer pumps these events
...
\subsection{\label{sNetwork}The Network Layer}
...
\begin{wrapfigure}{r}{.618\textwidth}
  ...
  {\caption{\small\label{fNetNode}Communication between two nodes}}
\end{wrapfigure}
