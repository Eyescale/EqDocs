...
Version 1.6 RC1 for Equalizer 0.9\\[\medskipamount]
%  \today
}
...
Corporation. All other trademarks and copyrights herein are the property
...
\listoffigures \vfill{\center\begin{tabularx}{\textwidth}{|l|l|X|}
    ...
    1.6 RC1 & Jul 31, 2009 & Release Candidate 1 for Equalizer 0.9\\
    \hline
  \end{tabularx}}
\clearpage
...
renders an even subset of the parent's pixels. Setting one or multiple
