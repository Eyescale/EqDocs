...
%  \textbf{RELEASE CANDIDATE}\\[\medskipamount]
  Version 1.1.10 for Equalizer 0.4+svn\\[\medskipamount]
  \today
}
...
\vfill{\center\begin{tabularx}{\textwidth}{|l|l|X|}
    ...
    1.1.8   & Jan 15, 2007 & Detailed window initialization based on
                             latest refactoring\\
    1.1.9   & Jan 16, 2007 & Detail distributed object usage\\
    1.1.10  & Jan 28, 2007 & Add creation thread for NodeFactory entities\\
    \hline
  \end{tabularx}}
\thispagestyle{empty}
\clearpage
