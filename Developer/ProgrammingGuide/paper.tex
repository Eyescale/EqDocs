...
%  \textbf{RELEASE CANDIDATE}\\[\medskipamount]
  Version 1.3.7 for Equalizer 0.5.4+svn\\[\medskipamount]
  \today
}
...
\vfill{\center\begin{tabularx}{\textwidth}{|l|l|X|}
    ...
    1.3.7   & Aug 22, 2008 & Update \sref{sEqplyWIndow} with OSWindow changes (event handling updates still missing)\\
    \hline
  \end{tabularx}}
\thispagestyle{empty}
\clearpage
