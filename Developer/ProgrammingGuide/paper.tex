...
\date{
  ...
  \end{textblock}
      ...
      Version 1.11.3 for Equalizer 1.4-beta\\[\medskipamount]
  \today
}
...
{\center\begin{tabularx}{\textwidth}{|l|l|X|}
    ...
    1.11.2  & Jun 25, 2012 & Add \sref{sScaling} and \sref{sROI}\\
    1.11.3  & Jun 26, 2012 & Add \sref{sZeroconf}, update \sref{sNetObject2} and \aref{aFileFormat}\\
    \hline
  \end{tabularx}}
\clearpage
