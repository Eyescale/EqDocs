...
Version 1.8.4 for Equalizer 1.1.5+git \\[\medskipamount]
%  \today
}
...
{\center\begin{tabularx}{\textwidth}{|l|l|X|}
    ...
    1.8.2   & Apr 04, 2011 & Added \sref{sFocusDistance}\\
    1.8.3   & Aug 10, 2011 & Rewrote \sref{sHello}\\
    1.8.4   & Nov 18, 2011 & Added \sref{sAutoConfig}\\
    \hline
  \end{tabularx}}
\clearpage
...
Please note that the ZeroConf module is optional and requires a ZeroConf
implementation when Equalizer is compiled.
...
\item \textsf{--eq-config sessionname} uses the dns\_sd ZeroConf module of
  ...
  session of the GPU-SD daemon is \textsf{default}. The ZeroConf hostname is
...
\begin{wrapfigure}{r}{.618\textwidth}
  \vspace{-3ex}\includegraphics[width=.618\textwidth]{images/dfr.pdf}
...
{\footnotesize\lstinputlisting[firstline=58, lastline=66]
...
{\footnotesize\lstinputlisting[firstline=47, lastline=55]
  {../../../Equalizer/examples/eqHello/hello.cpp}}
...
{\footnotesize\lstinputlisting[firstline=69, lastline=81]
  {../../../Equalizer/examples/eqHello/hello.cpp}}
...
{\footnotesize\lstinputlisting[firstline=57, lastline=68]
...
{\footnotesize\lstinputlisting[firstline=60, lastline=73]
...
{\footnotesize\lstinputlisting[firstline=138, lastline=154]
...
{\footnotesize\lstinputlisting[firstline=70, lastline=106]
...
{\footnotesize\lstinputlisting[firstline=180, lastline=226]
...
\begin{figure}[h!t]\center
  \subfigure[]{\label{fOrigin}
    \includegraphics[width=.49\textwidth]{images/focusOrigin}}\hfil
  \subfigure[]{\label{fObserver}
    \includegraphics[width=.49\textwidth]{images/focusObserver}}
