...
%  \textbf{RELEASE CANDIDATE}\\[\medskipamount]
  Version 1.3.10 for Equalizer 0.5.5\\[\medskipamount]
  \today
}
...
\begin{figure}[ht!]\center
  \includegraphics[width=.618\textwidth]{images/pixelKernels.pdf}
...
\begin{wrapfigure}{r}{.382\textwidth}
  \vspace{-2em}\includegraphics[width=.382\textwidth]{images/modelDist.pdf}
