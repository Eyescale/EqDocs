...
%  \textbf{RELEASE CANDIDATE}\\[\medskipamount]
  Version 1.3.2 for Equalizer 0.5+svn\\[\medskipamount]
  \today
}
...
\vfill{\center\begin{tabularx}{\textwidth}{|l|l|X|}
    ...
    1.3.3   & May 10, 2008 & File Format Appendix [incomplete]\\
    \hline
  \end{tabularx}}
\thispagestyle{empty}
\clearpage
...
\begin{tabularx}{\textwidth}{|l|X|}
  ...
  \textbf{Description} & The hostname or IP address used to connect the
...
\begin{tabularx}{\textwidth}{|l|X|}
  ...
  \textbf{Default} & ssh -n \%h \%c \textgreater\& \%h.\%n.log [POSIX]\\
                   & ssh -n \%h \%c [WIN32]\\
  \textbf{Description} & The command used by the server to launch nodes
...
\begin{tabularx}{\textwidth}{|l|X|}
  ...
  \textbf{Default} & ' [POSIX]\\
                   & '' [WIN32]\\
  \textbf{Description} & The server uses command line arguments to
...
\begin{tabularx}{\textwidth}{|l|X|}
  ...
  \textbf{Default} & TCPIP\\
  \textbf{Description} & The protocol for connections. SDP
...
\begin{tabularx}{\textwidth}{|l|X|}
  ...
  \textbf{Default} & 0\\
  \textbf{Description} & The listening port used by the server or
...
\textbf{Value} & OFF \textbar \ ON // AGL, WGL only\\
\textbf{Default} & \\
\textbf{Description} & \\
\hline
\end{tabularx}\\[\smallskipamount]
...
For an introduction on the concepts of nodes, pipes, windows, channels
and compounds please refer to \sref{sConfig} and \sref{sCompounds}.
