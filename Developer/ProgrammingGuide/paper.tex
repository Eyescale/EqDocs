...
\date{
  ...
  Version 0.9 for Equalizer v0.4\\[\medskipamount]
  \today
}
...
examples for this Programming Guide. The Quickstart
...
building the Equalizer solution on Windows. On Mac OS X, some
prerequisites have to be installed before running \textsf{make}, as
explained in \textsf{README.Darwin}.
...
is frequently used as a type by windowing systems. \fig{fUml} shows the
most important Equalizer classes and how they are subclassed in the
\textsf{eqPly} example. 
