...
Version 1.7.9 for Equalizer 0.9.1+svn\\[\medskipamount]
%  \today
}
...
\begin{tabularx}{\textwidth}{|l|X|}
  ...
  \textbf{Value} & AUTO \textbar QUAD \textbar \ ANAGLYPH\\
  \textbf{Default} & AUTO\\
  ...
  conjunction with colored glasses. AUTO selects QUAD if the drawable is capable
  of active stereo rendering, otherwise ANAGLYPH is selected\\
  \hline
\end{tabularx}\\\vfill
