...
%  \textbf{RELEASE CANDIDATE}\\[\medskipamount]
  Version 1.1.8 for Equalizer 0.4+svn\\[\medskipamount]
  \today
}
...
\begin{wrapfigure}{r}{.618\textwidth}
  \vspace{-2.5ex}\includegraphics[width=.618\textwidth]{images/render.pdf}
  {\caption{\small\label{fRender}Main Rendering Loop}\vspace{-2ex}}
\end{wrapfigure}
