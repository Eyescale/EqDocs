...
Methoden an. Das Erstellen und Füllen des Bounding Box Octrees wird dabei genau
...
Zweitens sollen die Informationen über die Struktur der polygonalen Daten 
...
genutzten Vertices ziehen zu können, und andererseits um Vertexnormalen 
anstatt von Flächennormalen berechnen zu können. Diese erlauben erst die 
Verwendung besserer Shading Algorithmen.

Drittens soll der neue Code heutigen objektorientierten Ansprüchen genügen,
...
Die für das Rendering relevanten Methoden von \emph{mesh::VertexBufferLeaf}
